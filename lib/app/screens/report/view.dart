...
class ReportPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: SafeArea(child: Obx(() {
      ...
      print('COMPLETED $completedTasks.toString()}');
      print('LIVE TASKS $liveTasks.toString()}');
      ...
      return ListView(children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              _buiildStatus(Colors.green, liveTasks, 'Live tasks'),
              _buiildStatus(Colors.orange, completedTasks, 'Completed'),
              _buiildStatus(Colors.blue, createdTasks, 'Created')
            ],
          ),
        ),
        SizedBox(
  ...
  Row _buiildStatus(Color color, int number, String text) {
    return Row(
